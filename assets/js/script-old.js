		...
		if ($.cookie('gritter_show')) {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    image: base_url+'assets/img/gritter/cloud.png',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: base_url+'assets/img/gritter/settings.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image: base_url+'assets/img/gritter/buy.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
	...
	return {
        ...
        init: function () {
			...
			if (App.isPage("dashboard_!")     || App.isPage("customers_information")|| 
			    App.isPage("manage_email_templates")  ||
				App.isPage("subcategories")        || App.isPage("categories")    || 
				App.isPage("sizes")  || App.isPage("suppliers_information")      || 
				App.isPage("list_products")   || App.isPage("employees_information") 				    || App.isPage("holidays")  	  ||
				App.isPage("list_purchases")      || App.isPage("allowances")    ||
				App.isPage("shifts") 	    || App.isPage("bonus") 		 ||
				App.isPage("leaves") 	    || App.isPage("taxes") 		 ||
				App.isPage("all_attendance")|| App.isPage("overtime")	  ||
				App.isPage("employee_salary_list")	  
				) {
