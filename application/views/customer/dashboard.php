									   ...
									   <div class="tab-pane active" id="ready">
													...
													<table id="datatable4" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
										                      ...
										                      <tbody>
										                          ...
										                          <td><?php echo $tro->od; ?></td>
										                          <td><?php echo $tro->td; ?></td>
									   ...
									   <div class="tab-pane" id="notReady">
										   			...
										   			<table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
										                      ...
										                      <tbody>
										                          ...
										                          <td><?php echo $tnro->od; ?></td>
										                          <td><?php echo $tnro->td; ?></td>
											  ...
											  <div class="panel-body orders no-opaque">
												<div class="scroller" data-height="450px" data-always-visible="1" data-rail-visible="1">
													<ul class="list-unstyled">
														<?php foreach($customerOrders as $td): 
															switch ($td->status) {
															    case "inprocess":
															        $valuenow = '40';
																	$label = 'warning';
														...
														<li class="clearfix">
															<div class="pull-left">
																<p>
																	<h5><strong>#<?php echo get_phrase('sub');?> <?php echo get_phrase('order'); ?> <?php echo $td->oid;?> (<?php echo $td->reference_no ?> )</strong> <?php echo $td->worker_name;?></h5>
																</p>
									   	...
									   	<div class="panel panel-default">
											  ...
											  <ul class="list-unstyled">
														...
														<li class="clearfix">
															<div class="pull-left">
																<p>
																	<h5><strong>#<?php echo get_phrase('sub');?> <?php echo get_phrase('order'); ?> <?php echo $cO->oid;?> (<?php echo $cO->reference_no ?> )</strong> <?php echo $cO->worker_name;?></h5>
																</p>
