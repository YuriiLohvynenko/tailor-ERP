            ...
            <div class="row">
                ...
                <?php }?>
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i><?php echo get_phrase("today's");?> <?php echo get_phrase('ready')?> <?php echo get_phrase('order');?></h4>
									...
									<div class="box-body">
										<table id="datatable2" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											?>
												...
												<td><?php echo $order->rd; ?></td>
                                                <td><?php echo $order->ord_Itms_Id; ?></td>
												<td><span class="label label-<?php if($order->st=='to_deliver'){$class = 'success';}echo $class;?> arrow-in arrow-in-right"><i class="fa fa-<?php echo $icon; ?>"></i> <?php echo get_phrase("ready_to_deliver");; ?></span></td>
                                            </tr>
											<?php 
												$i++;
											endforeach;?>	
