            ...
            <div class="row">
                ...
                <?php }?>
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i><?php echo get_phrase('not');?> <?php echo get_phrase('ready')?> <?php echo get_phrase('order')?> <?php echo get_phrase('till');?> <?php echo get_phrase('time');?></h4>
									...
									<div class="box-body">
										<table id="datatable2" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											foreach($orders as $order):?>
												...
												<td><span class="label label-warning arrow-in arrow-in-right"> <?php echo get_phrase('not').' '.get_phrase('ready') ?></span></td>
                                            </tr>
											<?php $i++;										
											endforeach;?>	
											</tbody>
