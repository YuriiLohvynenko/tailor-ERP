                ...
                <div class="col-sm-12">
                    <div class="page-header">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href=""><?php echo get_phrase('employee');?></a>
                            </li>
            ...
            <div class="row">
                ...
                <? }?>
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-list"></i><?php echo get_phrase('employee')?> <?php echo get_phrase('bonus')?></h4>
                        ...
                        <?php $attrib = array('class' => 'form-horizontal validate','id' => 'empBonusForm'); echo form_open(base_url().$roles.'/employees_bonus/search', $attrib); ?>
                          ...
                          <div class="wizard-content">
                            <div class="tab-content">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3"><?php echo get_phrase('employee');?><span class="required"></span></label>
                                                <div class="col-md-4">
												<?php
                                            $emp[""] = "";
                                            foreach ($employees as $employee) {
                                               $emp[$employee['emp_id']] = $employee['fname'].' '.$employee['lname'];                                              
                                            }
                                            echo form_dropdown('employee', $emp, (isset($_POST['employee']) ? $_POST['employee'] : $row['worker_id']), 'id="select4" class="col-md-12 select2-offscreen"');
                                            ?>
