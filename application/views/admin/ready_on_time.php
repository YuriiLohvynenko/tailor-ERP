            ...
            <div class="row">
                ...
                <?php }?>
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i><?php echo get_phrase('ready');?> <?php echo get_phrase('to')?> <?php echo get_phrase('deliver');?> <?php echo get_phrase('on');?> <?php echo get_phrase('time'); ?></h4>
