<?php
$edit_data=$this->db->get_where('categories' , array('id' => $param3) )->result_array();
foreach ( $edit_data as $r):
$row = $r;
endforeach;
if($param2=="edit_categories")
{
	$formAction = "do_update/".$param3;
}
else
{
	$formAction = "add_categories/";
}
?>
<div class="box border green" id="formWizard">
                        <div class="box-title">
                            <h4><i class="fa fa-bars"></i><?php echo get_phrase('categories')?></h4>
...
<?php echo form_open('admin/categories/'.$formAction , array('id' => 'categoriesForm', 'class' => 'form-horizontal'));?>
