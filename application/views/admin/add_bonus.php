<?php
$edit_data=$this->db->get_where('bonus' , array('id' => $param3) )->result_array();
foreach ( $edit_data as $r):
$row = $r;
endforeach;
if($param2=="edit_bonus")
{
	$formAction = "do_update/".$param3;
}
else
{
	$formAction = "add_bonus/";
}
?>
<div class="box border green" id="formWizard">
                        <div class="box-title">
                            <h4><i class="fa fa-bars"></i><?php echo get_phrase('bonus')?></h4>
...
<?php echo form_open('admin/bonus/'.$formAction , array('id' => 'bonusForm', 'class' => 'form-horizontal'));?>
                                        ...
                                        <div class="form-group">
                                           <label class="control-label col-md-3"> <?php echo get_phrase('bonus');?> <span class="required">*</span></label>
                                           <div class="col-md-6">
                                              <?php echo form_input('bonus', $row['bonus'], 'class="form-control" id="bonus" required="required" data-error="'.get_phrase("bonus").' '.get_phrase("is_required").'"'); ?>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="col-md-6">
                                              <?php 
  $type = array ('' => '', '1' => get_phrase("percentage").' (%)', '2' => get_phrase("fixed").'  ('.CURRENCY.')');
