            ...
            <div class="row">
                ...
                <?php }?>
								...
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-table"></i><?php echo get_phrase('ready');?> <?php echo get_phrase('to')?> <?php echo get_phrase('deliver');?> <?php echo get_phrase('after');?> <?php echo get_phrase('time');?></h4>
									...
									<div class="box-body">
										<table id="datatable2" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
											...
											?>
												...
												<td><span class="label label-success arrow-in arrow-in-right"><i class="fa fa-tick"></i> <?php echo get_phrase("ready_to_deliver");; ?></span></td>
                                            </tr>
											<?php $i++;
