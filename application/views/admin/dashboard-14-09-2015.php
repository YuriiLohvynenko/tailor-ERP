...
<?php   
//print_r($monthly_incomes);
        foreach($monthly_incomes as $month_income) {
        $months[] = date('M-Y', strtotime($month_income->month));
        $sales[] = $month_income->orders;
        $tax1[] = $month_income->tax1;
        $tax2[] = $month_income->tax2;
        $purchases[] = $month_income->purchases;
        $tax3[] = $month_income->ptax;
