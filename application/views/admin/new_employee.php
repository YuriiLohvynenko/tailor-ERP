        ...
        <div id="content" class="col-lg-12">
            ...
            <div class="row">
                ...
                <? }?>
						...
						<div class="row">
                        <?php echo form_open($roles.'/employees/'.$formAction , array('id' => 'employeesForm', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data'));?>
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="box border green">
											...
											<div class="box-body big">
												  ...
												  <div class="form-group">
													<label class="col-sm-4 control-label"><?php echo get_phrase('dob');?><span class="required">*</span> </label>
													
													 
                                                      <div class="input-group date dob col-md-8" data-date="" data-date-format="dd MM yyyy" data-link-field="dob" data-link-format="yyyy-mm-dd" style="padding-left:15px !important;">
                                        <input class="form-control" type="text" name="dateofbirth" value="<?php if($row['dob'])echo date("d M Y",strtotime($row['dob'])); ?>" placeholder="<?php echo get_phrase('dob');?>">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                    	<input type="hidden" name="dob" id="dob" value="<?php if($row['dob']) echo date("Y-m-d",strtotime($row['dob'])); ?>" />
													
												  </div>
                                                  
                                                  
												  <div class="form-group">
													<label class="col-sm-4 control-label"><?php echo get_phrase('gender');?> <span class="required">*</span></label>
													<div class="col-sm-8">
													  <select id="select2" name="sex" class="col-md-12 select2-offscreen">
                          <option value=""></option>
                            ...
                            <option <?php if($row['gender']=='female'){echo "selected";} ?> value="female"><?php echo get_phrase('female');?></option>
												  ...
												  <!--<div class="form-group">
													<label class="col-sm-4 control-label"><?php echo get_phrase('martial');?> <?php echo get_phrase('status');?><span class="required">*</span></label>
													<div class="col-sm-8">
													 <select id="marital" name="marital" class="col-md-12 select2-offscreen">
                          <option value=""></option>
                            ...
                            <option <?php if($row['martial_status']=='divorced'){echo "selected";} ?> value="divorced"><?php echo get_phrase('divorced');?></option>
                            <option <?php if($row['martial_status']=='widow'){echo "selected";} ?> value="widow"><?php echo get_phrase('widow');?></option>
                            </select>
													</div>
												  </div>-->
                                                  
												  <!--<div class="form-group">
													<label class="col-sm-4 control-label"><?php echo get_phrase('nationality');?> <span class="required">*</span></label>
													<div class="col-sm-8">
													  <select id="nationality" name="nationality" class="col-md-12 select2-offscreen">
                            <option value=""></option>
                            ...
                            <?php }?>
                                                  ...
                                                  <!--<div class="form-group">
													<label class="col-sm-4 control-label"><?php echo get_phrase('passport');?> <?php echo get_phrase('no');?> <span class="required">*</span></label>
													<div class="col-sm-8">
