<div id="sidebar" class="sidebar">
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
                            ...
                            <li class="has-sub <?php if($page_name == 'track_orders' || 
								...
								<ul class="sub">
									...
									<li class="<?php if($page_name=='track_orders')echo 'current';?>"><a  href="<?php echo base_url();?><?php echo $roles;?>/track_orders"><span class="sub-menu-text"><i class="fa fa-bars fa-fw"></i> <?php echo get_phrase('track');?> <?php echo get_phrase('orders');?></span></a></li>
							 ...
							 <li class="<?php if($page_name == 'employee_bonus')echo 'active';?>">
								<a href="<?php echo base_url().$roles;?>/bonus">
								<i class="fa fa-money fa-fw"></i> <span class="menu-text"><?php echo get_phrase('bonus');?></span>
								</a>					
							</li>
